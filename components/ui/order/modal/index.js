...
const createFormState = (
  ...
  if (!hasAgreedTOS) {
    return _createFormState(
      true,
      "You need to agree with Terms Of Service. In order to continue."
    );
  }
  return _createFormState();
};
              ...
              <div className="mt-3 sm:mt-0 sm:ml-4 sm:text-left">
                ...
                <div className="mt-1 relative rounded-md">
                  ...
                  <p className="text-xs text-gray-700">
                    ...
                    price will be lower, order can be declined (+- 2% slipage is
                    allowed)
                  </p>
                </div>
                {isNewPurchase && (
                ...
                <div className="text-xs text-gray-700 flex mt-5">
                  ...
                  <span>
                    I accept Eincode &apos;terms of service&apos; and I agree
                    that my order can be rejected in the case data provided
